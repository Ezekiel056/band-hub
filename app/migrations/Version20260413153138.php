...
final class Version20260413153138 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE songs (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(100) NOT NULL, duration SMALLINT DEFAULT NULL, bpm SMALLINT DEFAULT NULL, lyrics LONGTEXT DEFAULT NULL, status LONGTEXT NOT NULL, artist_id INT NOT NULL, INDEX IDX_BAECB19BB7970CF8 (artist_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(50) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(320) NOT NULL, created_at DATETIME NOT NULL, is_active TINYINT NOT NULL, last_band_id INT DEFAULT NULL, last_login DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
